...
class Scene:
    ...
    def calculate_gaussian_directions(self, means_3D, camera):
        ...
        camera_origin = camera.get_camera_center()
        gauss_dirs_unnormed = means_3D - camera_origin
        norm = torch.norm(gauss_dirs_unnormed, dim=1, keepdim=True)
        gaussian_dirs = gauss_dirs_unnormed / norm # (N, 3)
